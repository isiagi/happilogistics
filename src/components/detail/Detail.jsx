      ...
      <div className="detail__container">
        ...
        {(() => {
          switch (para.page) {
            ...
            case "ware":
              return <Dynamic title={img4} head="Warehousing & Distribution" />;
            case "insurane":
              return <Dynamic title={img1} head="CONTAINER LOAD & SHIPPING LINE" />;
            case "work":
          ...
          <div className="detail__container2">
            <div className="detail__content">
              ...
              <ul>
                <li><Link to='/detail/land'>Road transport</Link></li>
                <li><Link to='/detail/land'>Road transport</Link></li>
                <li><Link to='/detail/air'>Air frieght</Link></li>
                <li><Link to='/detail/water'>Water frieght</Link></li>
                <li><Link to='/detail/distribution'>Distribution & Delivery</Link></li>
                <li><Link to='/detail/ware'>Ware housing</Link></li>
                <li><Link to='/detail/insurance'>Cargo insurance</Link></li>
                <li><Link to='/detail/shipping'>Container Load & Shipping line</Link></li>
              </ul>
            </div>
          </div>
        </div>
